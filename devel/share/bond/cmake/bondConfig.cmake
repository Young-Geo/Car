...
if("TRUE" STREQUAL "TRUE")
  set(bond_SOURCE_PREFIX /home/pi/Car/src/bond_core/bond)
  set(bond_DEVEL_PREFIX /home/pi/Car/devel)
  set(bond_INSTALL_PREFIX "")
  set(bond_PREFIX ${bond_DEVEL_PREFIX})
else()
  set(bond_SOURCE_PREFIX "")
  set(bond_DEVEL_PREFIX "")
  set(bond_INSTALL_PREFIX /home/pi/Car/install)
...
if(NOT "/home/pi/Car/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bond' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/Car/src/bond_core/bond/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
