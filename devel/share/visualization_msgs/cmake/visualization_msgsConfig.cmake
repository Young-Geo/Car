...
if("TRUE" STREQUAL "TRUE")
  set(visualization_msgs_SOURCE_PREFIX /home/pi/Car/src/common_msgs/visualization_msgs)
  set(visualization_msgs_DEVEL_PREFIX /home/pi/Car/devel)
  ...
  set(visualization_msgs_INSTALL_PREFIX /home/pi/Car/install)
...
if(NOT "/home/pi/Car/devel/include " STREQUAL " ")
  set(visualization_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/Car/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'visualization_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/Car/src/common_msgs/visualization_msgs/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
